...
class VideoHeaderCell: UITableViewCell {
    ...
    //Se genera el Array del tipo de dato del Struct para el boton.
    ...
    func configCell(videoModel : VideoModel.Item, channelModel : ChannelModel.Item?){
        ...
        videoStatistics.highlight(searchedText: tags, color: UIColor.blue)
        
        channelDetails(videoModel, channelModel)
    }
    
    private func channelDetails(_ videoModel : VideoModel.Item, _ channelModel : ChannelModel.Item?){
