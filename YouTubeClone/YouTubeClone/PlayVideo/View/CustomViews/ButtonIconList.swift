...
class ButtonIconList: UIView {
    ...
    //Se crea el scrollView horizontal para contener todos los iconos
    ...
    //Se crea un stack vertical, para poner el icono y debajo el texto descriptivo.
